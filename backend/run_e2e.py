...
async def main():
    """Run E2E test with the diameter-right angle problem"""
    ...
    # Step 2: Load image
    print_section("Step 1: Loading Test Image")
    
    # Try to find a test image
    image_path = None
    possible_images = [
        BACKEND_DIR / "tests/data/CorrectSolution2.png",
        BACKEND_DIR / "tests/data/CorrectSolution1.png",
        BACKEND_DIR / "tests/data/WrongSolution1.png",
    ]
    ...
    if not image_path:
        print("❌ No test image found. Looking for images in:")
        for img in possible_images:
            print(f"   - {img}")
        print("\nPlease add a test image to tests/data/")
        return
    ...
    print_section("Step 3: Analyzing Image with LLM")
